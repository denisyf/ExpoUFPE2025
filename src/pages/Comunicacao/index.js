...
import { SafeAreaView, View, StyleSheet, Image, Text, ScrollView, TouchableOpacity, TextInput, Alert, ImageBackground } from 'react-native';
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <Animatable.View animation="fadeInUp" style={styles.containerForm}>
                    <View style={styles.containerConfig}>
                        <View style={{display: "flex", flexDirection: "column", padding: 16, width: 335, height: 92, backgroundColor: "#fff", borderRadius: 10, marginBottom: 10}}>
