...
import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, StyleSheet, Image, ImageBackground, Modal, LogBox } from 'react-native';
...
export default function Welcome() {
    ...
    const [payload1, setPayload1] = useState({
        mode: "",
        fill_speed: value1,  // o valor do slider
        empty_speed: value2
    });
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.containerHeader}>
                ...
                <Animatable.View animation="fadeInUp" style={styles.containerDispositivos}>
            ...
            <ScrollView contentContainerStyle={styles.containerForm}>
                ...
                <TouchableOpacity onPress={() => setDropdown1Open(!dropdown1Open)}>
                    <View style={styles.dropdownHeader}>
                        ...
                        <Icon name={dropdown1Open ? 'keyboard-arrow-up' : 'keyboard-arrow-down'} size={24} color="#333" />
                    </View>
                </TouchableOpacity>
                {dropdown1Open && (
                    <View style={styles.dropdownContent}>
                        ...
                        <View>
                            <View style={styles.switchContainer}>
                                <TouchableOpacity
                                    style={[styles.switchButton, styles.switchLeft, canaLigada && { backgroundColor: '#693B8F' }]}
                                    onPress={() => [setCanaLigada(true), sendMqttMessage('sugar_enable', 'true')]}>
                                    <Text style={[styles.switchText, canaLigada && { color: '#f0f0f0' }, !canaLigada && { color: '#fff' }]}>Ligar</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.switchButton, styles.switchRight, !canaLigada && { backgroundColor: '#693B8F' }]}
                                    onPress={() => [setCanaLigada(false), sendMqttMessage('sugar_enable', 'false')]}>
                                    <Text style={[styles.switchText, !canaLigada && { color: '#f0f0f0' }]}>Desligar</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
                ...
                <TouchableOpacity onPress={() => setDropdown2Open(!dropdown2Open)}>
                    <View style={styles.dropdownHeader}>
                        ...
                        <Icon name={dropdown2Open ? 'keyboard-arrow-up' : 'keyboard-arrow-down'} size={24} color="#333" />
                    </View>
                </TouchableOpacity>
                {dropdown2Open && (
                    <View style={styles.dropdownContent}>
                        ...
                        <View>
                            <View style={styles.switchContainer}>
                                <TouchableOpacity
                                    style={[styles.switchButton, styles.switchLeft, cacauLigada && { backgroundColor: '#693B8F' }]}
                                    onPress={() => [setCacauLigada(true), sendMqttMessage('cocoa_enable', 'true')]}>
                                    <Text style={[styles.switchText, cacauLigada && { color: '#f0f0f0' }, !cacauLigada && { color: '#fff' }]}>Ligar</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.switchButton, styles.switchRight, !cacauLigada && { backgroundColor: '#693B8F' }]}
                                    onPress={() => [setCacauLigada(false), sendMqttMessage('cocoa_enable', 'false')]}>
                                    <Text style={[styles.switchText, !cacauLigada && { color: '#f0f0f0' }]}>Desligar</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
                ...
                <TouchableOpacity onPress={() => setDropdown3Open(!dropdown3Open)}>
                    <View style={styles.dropdownHeader}>
                        ...
                        <Icon name={dropdown3Open ? 'keyboard-arrow-up' : 'keyboard-arrow-down'} size={24} color="#333" />
                    </View>
                </TouchableOpacity>
                {dropdown3Open && (
                    <View style={styles.dropdownContent}>
                        ...
                        <View>
                            <View style={styles.switchContainer}>
                                <TouchableOpacity
                                    style={[styles.switchButton, styles.switchLeft, leiteLigada && { backgroundColor: '#693B8F' }]}
                                    onPress={() => [setLeiteLigada(true), sendMqttMessage('milk_enable', 'true')]}>
                                    <Text style={[styles.switchText, leiteLigada && { color: '#f0f0f0' }, !leiteLigada && { color: '#fff' }]}>Ligar</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.switchButton, styles.switchRight, !leiteLigada && { backgroundColor: '#693B8F' }]}
                                    onPress={() => [setLeiteLigada(false), sendMqttMessage('milk_enable', 'false')]}>
                                    <Text style={[styles.switchText, !leiteLigada && { color: '#f0f0f0' }]}>Desligar</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
                ...
                <View style={styles.bannerControle}>
                    <TouchableOpacity onPress={openModalTanque1}>
                        <ImageBackground source={require("../../assets/Menu/tanqueLeite.png")} style={styles.controlButton} />
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.bannerControle}>
                    <TouchableOpacity onPress={openModalTanque2}>
                        <ImageBackground source={require("../../assets/Menu/tanqueChoco.png")} style={styles.controlButton} />
                    </TouchableOpacity>
                </View>
                    ...
                    <View style={styles.modalBackground}>
                        <View style={styles.modalContent}>
                            <TouchableOpacity onPress={closeModal} style={styles.closeButton}>
                                <Text style={{ fontSize: 16, color: '#fff', fontWeight: "bold" }}>Confirmar</Text>
                            </TouchableOpacity>
                            <Text style={styles.modalTextTitle}>Tanque de Leite</Text>
                            <Text style={styles.modalTextDescription}>Gerenciamento do conjunto de sensores e atuadores do tanque.</Text>
                            <Text style={{
                                position: 'absolute',
                                top: 110,
                                left: 5,
                                padding: 20,
                            }}>Nível dos tanques</Text>
                            <View style={{ flexDirection: "row", justifyContent: "space-araund" }}>
                                <View style={styles.tank}>
                                    <View style={[styles.fill, { height: `${value3}%` }]} />
                                </View>
                                <Text style={{ fontSize: 18, fontWeight: 'bold', top: 130, left: 30 }}>
                                    {value3}%{'\n'}
                                </Text>
                            </View>
                            <Text style={{
                                ...
                                left: 5,
                                padding: 20,
                            }}>Modo de operação:</Text>
                            <View style={{ marginTop: 20 }}>
                                <View style={styles.switchContainer}>
                                    <TouchableOpacity
                                        style={[styles.switchButton, styles.switchLeft, tanque1Ligada && { backgroundColor: '#693B8F' }]}
                                        onPress={() => {
                                        ...
                                        <Text style={[styles.switchText, tanque1Ligada && { color: '#f0f0f0' }, !tanque1Ligada && { color: '#fff' }]}>Automático</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity
                                        style={[styles.switchButton, styles.switchRight, !tanque1Ligada && { backgroundColor: '#693B8F' }]}
                                        onPress={() => {
                                            ...
                                            sendMqttMessage('milk_tank_config', {
                                                ...payload1, mode: "manual"
                                            });
                                        }}>
                                        <Text style={[styles.switchText, !tanque1Ligada && { color: '#f0f0f0' }]}>Manual</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", right: 48 }}>
                                ...
                                <Text style={{ fontWeight: "bold", fontSize: 16 }}> {(payload1.fill_speed * 100).toFixed(2)}L/s</Text>
                            </View>
                            <Slider
                                ...
                                onValueChange={value => {
                                    const scaledValue = value / 100;  // Escala de 0-100 para 0-1
                                ...
                                value={payload1.fill_speed * 100}  // Exibe o valor de 0-1 como 0-100 no slider
                            />
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", right: 18 }}>
                                ...
                                <Text style={{ fontWeight: "bold", fontSize: 16 }}> {(payload1.empty_speed.toFixed(2))}L/s</Text>
                            </View>
                            <Slider
                                maximumTrackTintColor="#ccc"
                                maximumValue={100}
                                ...
                                thumbTouchSize={{ width: 80, height: 80 }}
                                trackStyle={{ height: 10, borderRadius: 20 }}
                                value={payload1.empty_speed * 100}  // Exibe o valor de 0-1 como 0-100 no slider
                            />
                        </View>
                    </View>
                </Modal>
                ...
                >
                    <View style={styles.modalBackground}>
                        <View style={styles.modalContent}>
                            ...
                            <View style={{ flexDirection: "row", justifyContent: "space-araund" }}>
                                <View style={styles.tank}>
                                    <View style={[styles.fill, { height: `${value4}%`, backgroundColor: "#904C04" }]} />
                                </View>
                                <Text style={{ fontSize: 18, fontWeight: 'bold', top: 130, left: 30 }}>
                                    {value4}%{'\n'}
                                </Text>
                            ...
                            <View style={{ marginTop: 20 }}>
                                <View style={styles.switchContainer}>
                                    <TouchableOpacity
                                        style={[styles.switchButton, styles.switchLeft, tanque2Ligada && { backgroundColor: '#693B8F' }]}
                                        onPress={() => {
                                        ...
                                        <Text style={[styles.switchText, tanque2Ligada && { color: '#f0f0f0' }, !tanque2Ligada && { color: '#fff' }]}>Automático</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity
                                        style={[styles.switchButton, styles.switchRight, !tanque2Ligada && { backgroundColor: '#693B8F' }]}
                                        onPress={() => {
                                        ...
                                        <Text style={[styles.switchText, !tanque2Ligada && { color: '#f0f0f0' }]}>Manual</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            <View style={{ marginTop: 10 }}>
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", right: 48 }}>
                                <Text>Encher os tanques: </Text>
                                <Text style={{ fontWeight: "bold", fontSize: 16 }}> {payload2.fill_speed}L/s</Text>
                            </View>
                            <Slider
                                maximumTrackTintColor="#ccc"
                                maximumValue={100}
                                ...
                                thumbTouchSize={{ width: 80, height: 80 }}
                                trackStyle={{ height: 10, borderRadius: 20 }}
                                value={payload2.fill_speed * 100}  // Exibe o valor de 0-1 como 0-100 no slider
                            />
                            <View style={{ flexDirection: "row", alignItems: "center", right: 18 }}>
                                <Text>Esvaziamento dos tanques: </Text>
                                <Text style={{ fontWeight: "bold", fontSize: 16 }}> {(payload2.empty_speed.toFixed(2))}L/s</Text>
                            </View>
                            <Slider
                                maximumTrackTintColor="#ccc"
                                maximumValue={100}
                                ...
                                thumbTouchSize={{ width: 80, height: 80 }}
                                trackStyle={{ height: 10, borderRadius: 20 }}
                                value={payload2.empty_speed * 100}  // Exibe o valor de 0-1 como 0-100 no slider
                            />
                        </View>
                    </View>
                </Modal>
